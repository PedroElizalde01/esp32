...
void enviarAudioURL(String chat_id) {
  if (WiFi.status() == WL_CONNECTED) {
    HTTPClient https;
    String url = "https://api.telegram.org/bot" + String(botToken) + "/sendAudio";

    https.begin(url);
    https.addHeader("Content-Type", "application/x-www-form-urlencoded");

    // public mp3 url
    String audio_url = "https://www.sample-videos.com/audio/mp3/crowd-cheering.mp3"; //example
